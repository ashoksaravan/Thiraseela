...
import com.ashoksm.thiraseela.adapter.ArtistPagerAdapter;
...
public class ArtistDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewPager viewPager = (ViewPager) findViewById(R.id.artist_view_pager);
        ArtistPagerAdapter adapter = new ArtistPagerAdapter(ArtistListActivity.ARTIST_LIST_VOS, this);
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if (getSupportActionBar() != null) {
                    getSupportActionBar().setTitle(ArtistListActivity.ARTIST_LIST_VOS.get(position).getName());
                }
            }
